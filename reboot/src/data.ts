...
export const TECH_TREE: TechNode[] = [
  ...
  },
  {
    ...
    decisions: [
      ...
      { prompt: "Your settlement is modeled on a real siege where people survived 3 years using this exact method. Where was it?", choices: ["Sarajevo, Bosnia", "Goražde on the Drina River", "Beirut, Lebanon", "Aleppo, Syria"], answer: 1, success: "During the siege of Goražde (1992-95), residents built floating paddle-wheel platforms on the Drina River driving car alternators. They had electricity when the rest of the country didn't.", failure: "A history teacher speaks up: 'Goražde. Besieged for three years. They floated paddle wheels on the Drina River, hooked to car alternators. Had power the whole time.'" },
    ],
  },
  {
