...
export const TECH_TREE: TechNode[] = [
  // ═══════════ ERA 0: SURVIVAL ═══════════
  {
    ...
    details: [
      "Canned goods: 100+ yr shelf life sealed",
      "Freezers fail within hours without grid power",
      "1 supermarket sustains 1 person for decades",
      "Pests and rats will compete. Secure stores early",
      "Calorie density per kilo matters for transport",
    ],
    prereqs: [], x: 9, y: 135,
  ...
  },
  {
    ...
    details: [
      ...
      "Underground tanks hold ~30,000 gallons per station",
      "Stored fuel degrades within ~1yr without additives",
      "Filter gummy sediment before engine use",
      "Vehicle maintenance without factories is the real challenge",
    ],
    prereqs: [], x: 9, y: 271,
  ...
  },
  {
    ...
    details: [
      "90% of drugs outlast their printed expiry date",
      "Ciprofloxacin stays effective 10+ years past expiry",
      "Analgesics, antibiotics, antivirals: priority stockpile",
      "Blister packs extend shelf life vs open bottles",
      "Wound closure is critical without access to surgeons",
    ],
    prereqs: [], x: 9, y: 399,
    ...
    decisions: [
      ...
      { prompt: "The cut won't stop bleeding and you have no sutures. A mechanic offers his superglue. Do you use it?", choices: ["Absolutely not, glue is toxic on wounds", "Yes, superglue can bond skin edges shut", "Only if you dilute it with water first", "Wrap it tight with duct tape instead"], answer: 1, success: "Superglue (cyanoacrylate) has closed battlefield wounds since Vietnam. Clean the wound, pull edges together, apply along the surface.", failure: "The nurse nods at the superglue. 'Medics used this in Vietnam. Clean the wound, pull it shut, and glue along the seam. It works.'" },
    ],
  },
  {
    ...
    details: [
      "Modern infrastructure fails without the power grid",
      "Bodies and contaminated water spread disease fast",
      "Settlement location determines long-term survival",
      "Building age affects off-grid livability",
      "Metal salvage from ruins stays valuable for decades",
    ],
    prereqs: [], x: 9, y: 528,
  ...
  },
  {
    ...
    title: "RADIO COMMS", flavor: "Beyond line of sight",
    details: [
      "GPS depends on ground station corrections to stay accurate",
      "Walkie-talkies cover local distances only",
      "Cell phone towers run on backup power with limited fuel",
      "Morse code: lowest power, longest range of any signal",
      "Frequency band determines range and reliability",
    ],
    prereqs: [], x: 9, y: 656,
    ...
    decisions: [
      ...
      { prompt: "For long-range contact with other survivor groups, what's your best option?", choices: ["Keep trying cell phones, towers have backup generators", "Set up a CB or ham radio system", "Send runners with written messages", "Build a signal fire network"], answer: 1, success: "Cell towers run out of backup fuel in days. CB and ham radios need nothing but the radio itself. Your lifeline to other survivors.", failure: "The trucker laughs. 'Cell towers died days ago. CB radio is how I've talked across the country for 30 years. No infrastructure needed.'" },
    ],
  },
  {
    ...
    details: [
      "Not all batteries tolerate the same depth of discharge",
      "Salvage inverter: DC to 120V AC for appliances",
      "Parking garages, golf courses, RV lots, warehouses",
      "Lead-acid: rechargeable, refillable, durable",
      "Solar panel lifespan is measured in decades, not years",
    ],
    prereqs: [], x: 9, y: 785,
    scenario: "You need electricity for medical equipment and radios. Someone found car batteries in a parking garage. Another person suggests raiding the golf course instead. Limited vehicles, so you can only make one trip.",
    decisions: [
      ...
      { prompt: "You found solar panels on a warehouse roof. How fast do they degrade?", choices: ["They'll be useless within a year", "About 1% per year", "They never degrade", "50% loss in the first decade"], answer: 1, success: "Solar panels lose about 1% output per year. In 50 years they'll still produce half their rated power. A gift that lasts generations.", failure: "The engineer checks the spec sheet. 'These lose about 1% a year. Your grandchildren will still be using them.'" },
    ],
  },
  ...
  // ═══════════ ERA 1: STABILITY ═══════════
  {
    ...
    details: [
      "Contaminated water kills faster than hunger",
      "Cloth filtering removes debris but not microbes",
      "Chlorine tablets from pool supply stores",
      "Sand + gravel + charcoal = simple filter stack",
      "Well and latrine placement prevents groundwater contamination",
    ],
  ...
  },
  {
    ...
    details: [
      "Seeds left in abandoned fields die within one season",
      "Wheat, rye, barley, corn, potato, legumes: core crops",
      "Seed type determines whether you can save for next year",
      "Soil nitrogen depletes fast under monoculture",
  ...
  },
  {
    ...
    details: [
      "Running water is free, continuous mechanical energy",
      "Dead cars are full of useful electrical components",
      "Windmill: curved sheet steel + bicycle gear/chain",
      "Solar panels degrade slowly over decades",
      "History's survivors found ways to generate power from scrap",
    ],
    ...
    decisions: [
      { prompt: "The engineer wants to build a water wheel on the river and attach... what from a car?", choices: ["The engine", "The alternator", "The transmission", "The radiator fan"], answer: 1, success: "Every car has an alternator that outputs steady 12V DC regardless of how fast it spins. There are a billion cars on Earth. a billion generators waiting to be repurposed.", failure: "The engineer taps the alternator. 'This little box produces 12 volts no matter how fast you spin it. Every car has one. We have a billion generators sitting in parking lots.'" },
      { prompt: "Your settlement is modeled on a real siege where people survived 3 years using this exact method. Where was it?", choices: ["Sarajevo, Bosnia", "Goražde, Bosnia", "Beirut, Lebanon", "Aleppo, Syria"], answer: 1, success: "During the siege of Goražde (1992-95), residents built floating paddle-wheel platforms on the Drina River driving car alternators. They had electricity when the rest of the country didn't.", failure: "A history teacher speaks up: 'Goražde. Besieged for three years. They floated paddle wheels on the Drina River, hooked to car alternators. Had power the whole time.'" },
    ],
  },
  {
    ...
    details: [
      "Salt draws moisture out and halts microbial growth",
      "Smoking: phenol compounds are antimicrobial",
      "Acid concentration determines preservation effectiveness",
      "Lactic fermentation: sauerkraut, kimchi, yogurt",
      "Cheese: months of milk nutrition, fat-soluble vitamins",
    ],
  ...
  },
  {
    ...
    details: [
      ...
      "Chickens: eggs and pest control in fields",
      "Manure closes the nutrient loop back to the soil",
    ],
...

  {
    ...
    details: [
      "For 10,000 years, beer was safer than most water sources",
      "Sourdough and beer share the same fermentation knowledge",
      "'Small beer': daily drink for medieval adults AND children",
      "Fermentation transforms ingredients into something hostile to disease",
  ...
  // ═══════════ ERA 2: FOUNDATION ═══════════
  {
    ...
    details: [
      "3-field system: grain, legume, fallow prevents exhaustion",
      "Legumes fix N₂ from air into soil nitrogen",
      "Fallow allows microbial recovery but wastes a growing season",
      "Yields increase 30-50% vs monoculture",
      "More advanced rotations can eliminate wasted years entirely",
    ],
    ...
    decisions: [
      { prompt: "In the Norfolk four-course system, what replaces the wasteful fallow year?", choices: ["More wheat", "Root crops like turnips", "Corn", "Leaving it empty but plowing twice"], answer: 1, success: "Turnips and other root crops replace fallow. They suppress weeds while producing winter livestock feed. No wasted years.", failure: "The agronomist draws in the dirt: 'Turnips replace fallow. They choke weeds AND feed your animals through winter. Zero waste.'" },
      { prompt: "Why does rotating different crops each year reduce pest damage?", choices: ["Different crops need different amounts of water", "Many pests are crop-specific and starve when their host isn't there", "It confuses insects", "The soil pH changes"], answer: 1, success: "Wheat pests can't eat turnips. Rotate crops and you break the pest lifecycle. No pesticides needed.", failure: "You find the wheat weevils dead in the turnip rows. Not poisoned, just confused and starving. 'They evolved to eat one thing,' the agronomist says. 'Deny them that thing. Rotation is the oldest pesticide there is.'" },
    ],
  },
  {
    ...
    details: [
      "Potash: leach water through wood ash to make lye (KOH)",
      "Boil lye + rendered tallow = saponification",
      "Hard soap: cool and cut; soft soap stays liquid",
      "Handwashing halves transmission of gut disease",
      "Not all alkalis produce real lather",
    ],
    ...
    decisions: [
      ...
      { prompt: "Someone tries making soap with slaked lime (calcium hydroxide) directly. It doesn't lather. Why?", choices: ["The lime wasn't hot enough", "Calcium doesn't produce true soap; you need a different alkali", "They used too much fat", "Lime soap needs to cure for months"], answer: 1, success: "Calcium soaps form insoluble scum. like hard water deposits. You need to convert the calcium compound to potassium or sodium hydroxide first.", failure: "The chemist scrubs her hands with the result and holds up the grey waxy ring left in the bucket. 'Scum, not soap. Calcium bonds to the fatty acids all wrong. React the lime with potash first. That gets you potassium hydroxide. Then it lathers.'" },
    ],
  },
  {
    ...
    details: [
      ...
      "Pyrolysis drives off moisture and volatile compounds",
      "Water purification: activated charcoal adsorbs toxins",
      "15% of gunpowder formula (KNO₃ + C + S)",
      "The foundation of metallurgy: no charcoal, no metal",
    ],
    prereqs: ["Shelter", "Fuel"], x: 509, y: 347,
  ...
  },
  {
    ...
    details: [
      ...
      "Weave pattern determines strength and flexibility",
    ],
    ...
    decisions: [
      ...
      { prompt: "Your weaver produces a tough diagonal-patterned fabric. What weave is this?", choices: ["Plain weave", "Satin weave", "3/1 twill", "Basket weave"], answer: 2, success: "Twill weave: the weft floats over three warp threads, then crosses one. Creates a diagonal pattern. More flexible and durable than plain weave. This is how denim is made.", failure: "The weaver holds it up. '3/1 twill. Weft over three, cross one. Same pattern as denim. tough, flexible, perfect for work clothes.'" },
    ],
  },
  {
    ...
    details: [
      ...
      "Temperature determines whether pottery holds water",
      "Glazing techniques seal the surface permanently",
      "Precursor skills for glassmaking kiln technique",
    ],
    prereqs: ["Shelter"], x: 509, y: 733,
    ...
    decisions: [
      { prompt: "The pots are porous and leak. What temperature do you need to reach to make clay truly watertight?", choices: ["300-500°C", "500-800°C", "Above 900°C, hot enough to fuse the clay", "Any campfire will do"], answer: 2, success: "Above 900°C, impurities in the clay melt and fuse into a glassy matrix between the clay particles. The result is watertight ceramic.", failure: "The potter adjusts the kiln. 'We need more heat. above 900 degrees. That's when the silica melts and seals the clay. Below that, it stays porous.'" },
      { prompt: "The potter throws salt into the kiln during firing. Why?", choices: ["To lower the temperature needed", "The sodium bonds with the clay to seal it", "To prevent cracking", "It's a superstition"], answer: 1, success: "Salt glazing: sodium from the salt reacts with silicon in the clay at high temperature, forming a thin glass coating. Waterproof and beautiful.", failure: "The pot comes out gleaming without any applied glaze. The potter tosses in another handful of salt without explanation. 'Sodium found the silicon. Made its own glass. Waterproof, permanent, and we didn't even have to try.'" },
    ],
  },
  {
    ...
    details: [
      ...
      "Willow bark has been used for pain since Hippocrates",
      "Opium poppy: pain relief for surgery",
      "Antiseptic concentration matters more than strength",
    ],
  ...
  // ═══════════ ERA 3: INDUSTRY ═══════════
  {
    ...
    details: [
      ...
      "Ore sources: hematite Fe₂O₃, magnetite Fe₃O₄",
      "Reaches 1200°C but iron melts at 1538°C",
      "Bloom = spongy iron + slag; hammer out the slag",
      "Iron ore can come from surprising places",
    ],
    ...
    decisions: [
      { prompt: "The 'dead city' team argues that rusted steel IS iron ore. Are they right?", choices: ["No, rust is useless", "Yes, rust is chemically identical to natural iron ore", "Only if you melt it at over 2000°C", "Rust is a different chemical entirely"], answer: 1, success: "Rusted steel is iron oxide. chemically identical to hematite ore. The dead cities are the richest iron mines on the planet.", failure: "The blacksmith nods. 'Rust IS ore. Fe₂O₃. Every rusted car, every corroded beam. it's all hematite. The old cities are our mines.'" },
      { prompt: "Carbon in charcoal lowers iron's melting point. The blast furnace was invented far earlier than most people think. When?", choices: ["Roman Empire", "5th century BC", "Medieval Europe around 1200 AD", "The Industrial Revolution"], answer: 1, success: "China had blast furnaces by the 5th century BC. nearly 2,000 years before Europe. Carbon from charcoal lowers iron's melting point to ~1,200°C.", failure: "The blacksmith pauses mid-swing. 'Who figured this out first?' The historian doesn't look up. 'China. Fifth century BC. Two thousand years before Europe. The Industrial Revolution was a rediscovery.'" },
    ],
  },
  {
    ...
    details: [
      "Pure silica melts far too hot for simple kilns",
      ...
      "Five of the six key scientific instruments need glass",
    ],
    ...
    decisions: [
      { prompt: "Pure silica melts at ~1,650°C. far too hot for your kiln. Why does adding soda ash and lime help?", choices: ["They make the glass stronger", "They lower the melting point and stabilize the glass", "They change the color", "They reduce fuel consumption but don't affect temperature"], answer: 1, success: "Soda ash (flux) drops the melting point dramatically. But soda-silica glass would dissolve in rain! Lime makes it insoluble. That's the soda-lime glass recipe used for 5,000 years.", failure: "The kiln master holds the result up to the rain. The glass goes milky and starts to etch where water hits it. 'Beautiful. Dissolves in a week. You forgot the lime. That's what keeps it from melting in the first puddle.'" },
  ...
  },
  {
    ...
    details: [
      "The raw material for paper changed dramatically in the 1800s",
      "Pour slurry onto mesh screen (mould and deckle)",
      "Press between felts; air dry flat",
      "Enables writing, record-keeping, printing press",
      "Wood pulp requires acid/alkali digestion (later era)",
    ],
  ...
  },
  {
    ...
    details: [
      "Separation relies on different boiling points",
      "Brew: malted barley + yeast, then wort, then distill",
      "Ethanol: antiseptic, solvent, clean fuel",
      "Vinegar: oxidize ethanol to acetic acid",
  ...
  },
  {
    ...
    details: [
      "N, P, K: the three elements every crop needs",
      "Most natural sources are closer than you think",
      "Potassium: wood ash (potash = K₂CO₃)",
      "Compost provides all three plus trace minerals",
      "Haber-Bosch (later): N₂ + H₂ to NH₃ = synthetic N",
    ],
  ...
  // ═══════════ ERA 4: ADVANCED ═══════════
  {
    ...
    details: [
      "Cast iron: brittle, good for casting",
      "Wrought iron: soft, workable",
      "Carbon content is the difference between brittle and strong",
      "Enables precision parts, springs, cutting tools",
      "Mass production of quality steel transformed the 19th century",
    ],
    ...
    decisions: [
      ...
      { prompt: "The Bessemer process revolutionized steelmaking. What's the core idea?", choices: ["Heat iron longer", "Blast air through molten pig iron to burn out the excess carbon", "Add more carbon", "Cool it faster"], answer: 1, success: "Blow air through molten pig iron. the oxygen burns excess carbon to CO₂. Remove ALL carbon, then add back exactly the percentage you want. Cheap mass production of steel.", failure: "The iron comes out wrong. Too brittle. The blacksmith runs a hand along the break. 'Too much carbon left. Blast air through the molten iron next time. Oxygen burns the carbon out as CO₂. Then add back exactly what you want. Bessemer discovered this in 1856 and made steel cheap enough to build a world.'" },
    ],
  },
  {
    ...
    details: [
      ...
      "Watt: separate condenser keeps cylinder hot",
      "Powers mills, pumps, locomotion without animals",
      "Double-acting piston: power on both strokes",
      "Speed regulation is critical for safe, consistent operation",
    ],
    prereqs: ["Iron"], x: 1009, y: 271,
    scenario: "A cave-in at the ore mine. Water is flooding the shaft and your one pump is failing. Engineer Vasquez has been drawing steam engine plans for months that nobody took seriously. She's asking for four days and a pile of scrap iron. You don't have four days. You have two.",
    decisions: [
  ...
  },
  {
    ...
    details: [
      "Wine press technology adapted for printing",
      "Set letters in frame, ink, press onto paper",
      "Knowledge spreads exponentially, defeating forgetting",
      "Clay type is easier first; metal type lasts longer",
      "Printing ink differs fundamentally from writing ink",
    ],
    ...
    decisions: [
      { prompt: "Gutenberg's breakthrough wasn't the press itself (which came from wine-making). What was his key innovation?", choices: ["Carving each page into a wood block", "Reusable metal type cast from a precision mould", "Using clay type", "Inventing paper"], answer: 1, success: "The adjustable mould with a swappable matrix. cast identical metal letters quickly, in any width. Set them, print thousands of copies, then reuse the letters. Knowledge becomes unstoppable.", failure: "The metalworker explains: 'It's the mould. A steel punch stamps a letter into copper. That matrix goes in an adjustable mould. Pour lead alloy. Identical type, every time.'" },
      { prompt: "Printing ink is different from writing ink. What's it made from?", choices: ["Water-based iron gall ink", "Carbon soot suspended in plant oil", "Carbon and gelatin", "India ink"], answer: 1, success: "Oil-based ink: lampblack (carbon soot) suspended in linseed or walnut oil. Water-based ink would bead off the metal type. The oil clings and transfers cleanly.", failure: "The printer shakes his head. 'Water-based ink beads off metal type. You need oil-based. lampblack in linseed oil. Thick, sticky, and it transfers perfectly.'" },
    ],
  },
  {
    ...
    details: [
      "Electric current and magnetism are deeply connected",
      "Faraday: moving magnet creates current in coil",
      "Generator: spin coil in magnets = electricity",
      "Motor: electricity in coil creates rotation (reversed)",
  ...
  },
  {
    ...
    details: [
      "Before germ theory, disease was blamed on 'bad air'",
      ...
      "Proving microbes cause disease changed medicine forever",
    ],
    ...
    decisions: [
      { prompt: "She heats broth in a sealed flask, and it never spoils. She heats broth in an open flask, and it rots within days. What does this prove?", choices: ["Heat sterilizes food", "Microbes enter from outside; nothing grows spontaneously", "Sealed containers preserve food better", "Air itself causes rot"], answer: 1, success: "Pasteur's experiment: sealed heated broth stays sterile because no microbes can enter. Open broth rots because airborne microbes land in it. Germ theory proven.", failure: "The doctor explains: 'The sealed broth stayed sterile. The open broth rotted. The microbes came from the air. they don't just appear. That's germ theory.'" },
      { prompt: "Your dairy farmer wants to make milk safe to drink. At what temperature should it be heated?", choices: ["45-50°C", "65-70°C, briefly", "90-100°C", "120°C"], answer: 1, success: "Pasteurization: heat to 65-70°C briefly. Kills tuberculosis bacteria and other pathogens while preserving nutrition and flavor. Named after Pasteur himself.", failure: "The doctor corrects: '65 to 70 degrees, just briefly. That's pasteurization. Kills the dangerous microbes without cooking the milk.'" },
    ],
  },
  {
    ...
    details: [
      ...
      "Simple lens: 10x magnification achievable easily",
      "Compound microscope: two lenses, see bacteria",
      "Telescope: navigation by stars, distance warfare",
      "Spectacles restore decades of irreplaceable expertise",
    ],
  ...
  // ═══════════ ERA 5: RENAISSANCE ═══════════
  {
    ...
    details: [
      "One of the simplest electrical devices imaginable",
      "Morse 1837, but achievable much sooner with a guide",
  ...
  },
  {
    ...
    details: [
      "The discovery was an accident on a contaminated plate",
      ...
      "Purification requires understanding solvent chemistry",
    ],
  ...
  },
  {
    ...
    details: [
      "The mechanism that controls tick rate is the key invention",
      "Pendulum: Galileo observed isochronous swing",
  ...
  },
  {
    ...
    details: [
      "Dartnell calls this the ultimate accelerant of progress",
      "Falsifiability (Popper): must be testable and disprovable",
      "Controlled experiment: change one variable at a time",
      "Peer review: knowledge becomes collective and cumulative",
      "Printing press makes it self-reinforcing",
      "One sentence of science, chosen well, can seed a civilization",
    ],
  ...
  },
  {
    ...
    details: [
      "Silver halides (AgBr, AgCl) are sensitive to light",
      "Exposure: photons reduce Ag⁺ ions to metallic silver",
      "Developer (pyrogallol): amplifies the latent image",
      "Unfixed images keep darkening until ruined",
  ...
  },
  {
    ...
    details: [
      ...
      "Diesel and gasoline engines ignite fuel differently",
      "Next civilization runs on what it can grow, not drill",
      "Enables vehicles, pumps, generators, agriculture",
      "Rudolf Diesel had a broader vision than petroleum",
    ],
    prereqs: ["Steel", "Distillation"], x: 1259, y: 876,
    scenario: "The steam engine runs the mill and the mine pump, but it weighs as much as a house and needs three people to tend it. Your lead engineer wants power you can put in a cart. The catch: petrol stocks are nearly gone. Whatever you build has to run on what you can grow.",
    decisions: [
      { prompt: "A diesel engine doesn't need spark plugs. How does it ignite the fuel?", choices: ["A glow plug heats the fuel", "Pure compression heats the air enough to ignite fuel", "An external flame", "Chemical ignition"], answer: 1, success: "Diesel cycle: compress air so hard it reaches ignition temperature, then inject fuel. It ignites on contact. No spark plugs, no electrical ignition system. Robust and simple.", failure: "The engineer demonstrates: 'Compress the air until it's scorching hot. Inject the fuel. boom. That's diesel. No spark needed. Rudolf Diesel knew this would outlast gasoline.'" },
      { prompt: "With fossil fuels depleted, what can diesel engines run on?", choices: ["Nothing, they're useless without petroleum", "Vegetable oil and biofuels from crops", "Only coal dust", "Hydrogen"], answer: 1, success: "Diesel himself demonstrated his engine running on peanut oil at the 1900 World's Fair. Biofuels from crops make the internal combustion engine sustainable for the next civilization.", failure: "The engineer reads from a history book: 'Diesel ran his first engine on peanut oil in 1900. He always intended it for agricultural fuels. The petroleum era was a detour.'" },
    ],
  },
];
...
export const CONNECTIONS: Connection[] = [
  ...
  { from: "Shelter", to: "Charcoal", color: "#d68910", path: "M 233 581 C 370 581 380 402 509 402", dashed: true, width: 0.9, opacity: 0.3 },
  { from: "Fuel", to: "Charcoal", color: "#d68910", path: "M 233 324 C 370 324 380 402 509 402", dashed: true, width: 0.9, opacity: 0.3 },
  { from: "Shelter", to: "Pottery", color: "#7f8c8d", path: "M 233 581 C 370 581 380 788 509 788", dashed: true, width: 0.9, opacity: 0.3 },
  ...
  // WITHIN ERA 2
  { from: "Charcoal", to: "Lime", color: "#7f8c8d", path: "M 621 457 L 621 481", width: 1, opacity: 0.5 },
